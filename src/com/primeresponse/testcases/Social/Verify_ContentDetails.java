...
public class Verify_ContentDetails extends DriverTestCase{

	@Test
	public void testVerify_ContentDetails() throws Exception {
		...
		try {
			...
			socialHelper.verify_ContentDetails();
			ExecutionLog.Log("Verify content details on Social>Content page.");

		}

		catch (Error e) {
			captureScreenshot("testVerify_ContentDetails");
