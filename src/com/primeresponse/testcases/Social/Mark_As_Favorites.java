...
public class Mark_As_Favorites extends DriverTestCase{

	@Test
	public void testMark_As_Favorites() throws Exception {
		...
		try {
			...
			//Method to mark content as Favorite
			socialHelper.markContentFavorite();
