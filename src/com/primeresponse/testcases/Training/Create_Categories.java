...
public class Create_Categories extends DriverTestCase {

	@Test
	public void testCreate_Categories() throws Exception {
		...
		try {
			...
			//Verify process of creating new category
			trainingHelper.create_Category();
			ExecutionLog.Log("Verify process of creating new category");
			...
			captureScreenshot("testCreate_Categories");
