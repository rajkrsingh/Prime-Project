...
public class Verify_GoogleCampaignsOnSiteMapPosts extends DriverTestCase {

	@Test
	public void testVerify_GoogleCampaignsOnSiteMapPosts() throws Exception {
		...
		try {
			...
			captureScreenshot("testVerify_GoogleCampaignsOnSiteMapPosts");
