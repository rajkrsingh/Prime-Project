...
public class Sort_SocialSiteReferralBounceRateCol extends DriverTestCase {

	@Test
	public void testSort_SocialSiteReferralBounceRateCol() throws Exception {
		...
		try {
			...
			//Verify sorting functionality of 'Bounce Rate' column 
			webHelper.sort_SocialSiteReferralBounceRateCol();
			...
			captureScreenshot("testSort_SocialSiteReferralBounceRateCol");
