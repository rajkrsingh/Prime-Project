...
public class Delete_IntegratedAccounts extends DriverTestCase{
	
	@Test
	public void testDelete_IntegratedAccounts() throws Exception {
...
//			ExecutionLog.Log("Go to Settings > Social Integration");
			...
			captureScreenshot("testDelete_IntegratedAccounts");
