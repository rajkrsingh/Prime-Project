...
public class Verify_GoogleAnalyticsIntegrations extends DriverTestCase{

	@Test
	public void testVerify_GoogleAnalyticsIntegrations() throws Exception {
		...
		try {
			...
			settingHelper.verify_GoogleAnalyticsIntegrations();
			ExecutionLog.Log("Integrate Accounts with Google Analytics and verify that account is showing OFF by default.");
			...
			captureScreenshot("testVerify_GoogleAnalyticsIntegrations");
