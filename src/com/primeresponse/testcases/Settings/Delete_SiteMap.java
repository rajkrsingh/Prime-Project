...
public class Delete_SiteMap extends DriverTestCase{
	
	@Test
	public void testDelete_SiteMap() throws Exception {
		...
		try {
			...
			captureScreenshot("testDelete_SiteMap");
