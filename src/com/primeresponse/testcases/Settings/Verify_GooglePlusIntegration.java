...
public class Verify_GooglePlusIntegration extends DriverTestCase{

	@Test
	public void testVerify_GooglePlusIntegration() throws Exception {
		...
		try {
			...
			///***This FEATURE HAS BEEN REMOVED now******/////////

			//Integrate Accounts with Google Plus and verify that account is showing OFF by default.
			//settingHelper.verify_GooglePlusIntegration();
			//ExecutionLog.Log("Integrate Accounts with Google Plus");
			...
			captureScreenshot("testVerify_GooglePlusIntegration");
