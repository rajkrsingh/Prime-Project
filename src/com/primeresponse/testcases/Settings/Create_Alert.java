...
public class Create_Alert extends DriverTestCase{
	
	@Test
	public void testCreate_Alert() throws Exception {
		...
		try {
			...
			// Enter details and create alerts
			settingHelper.submitReviewAlerts("Internal Review");
			ExecutionLog.Log("Enter details and create alerts");
			...
			captureScreenshot("testCreate_Alert");
