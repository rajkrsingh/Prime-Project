...
public class Verify_ExternalFeedsDefaultSorting extends DriverTestCase {

	@Test
	public void testVerify_ExternalFeedsDefaultSorting() throws Exception {
		...
		try {
			...
			// Check default sorting of date column
			enterpriseHelper.checkDateSort();
			ExecutionLog.Log("Check default sorting of date column");

		}

		catch (Error e) {
			captureScreenshot("testVerify_ExternalFeedsDefaultSorting");
