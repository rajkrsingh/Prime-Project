...
public class Sort_Dashboard_ReviewResponsesCol extends DriverTestCase  {
	
	@Test
	public void testSort_Dashboard_ReviewResponsesCol() throws Exception {
		...
		try {
			...
			// Store the Review Responses in array and check sorting 
			enterpriseHelper.checkReviewResponsesSort(nrow);
			ExecutionLog.Log("Store the Review Responses in array and check sorting");
			
		} 
		
		catch (Error e) {
			captureScreenshot("testSort_Dashboard_ReviewResponsesCol");
