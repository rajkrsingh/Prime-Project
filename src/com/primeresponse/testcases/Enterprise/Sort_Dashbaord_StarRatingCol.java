...
public class Sort_Dashbaord_StarRatingCol extends DriverTestCase {

	@Test
	public void testSort_Dashbaord_StarRatingCol() throws Exception {
		...
		try {
			...
			captureScreenshot("testSort_Dashbaord_StarRatingCol");
