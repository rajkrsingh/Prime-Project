...
public class Reports_DownloadCSV extends DriverTestCase{
	
	@Test
	public void testReports_DownloadCSV() throws Exception {
		...
		try {
           ...
           //Method to download CSV file on enterprise reporting page
			...
			enterpriseHelper.reports_DownloadCSV(path);
			ExecutionLog.Log("Method to download CSV file on enterprise reporting page");
				
	  }

		catch (Error e) {
			captureScreenshot("testReports_DownloadCSV");
