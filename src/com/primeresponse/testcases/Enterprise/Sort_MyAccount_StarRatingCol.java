...
public class Sort_MyAccount_StarRatingCol extends DriverTestCase {
	
	@Test
	public void testSort_MyAccount_StarRatingCol() throws Exception {
		...
		try {
			...
			// Store the Star Rating in array and check the sorting 
			enterpriseHelper.checkStarRatingSort(nrow);
			ExecutionLog.Log("Store the Star Rating in array and check the sorting ");
			
		}

		catch (Error e) {
			captureScreenshot("testSort_MyAccount_StarRatingCol");
