...
public class Sort_MyAccount_FacebookLikesCol extends DriverTestCase {
	
	@Test
	public void testSort_MyAccount_FacebookLikesCol() throws Exception {
		...
		try {
			...
			captureScreenshot("testSort_MyAccount_FacebookLikesColt");
			ExecutionLog.LogErrorMessage(e);
			throw e;
		} catch (Exception e) {
			captureScreenshot("testSort_MyAccount_FacebookLikesCol");
