...
public class Sort_MyAccount_ReviewResponsesCol extends DriverTestCase {
	
	@Test
	public void testSort_MyAccount_ReviewResponsesCol() throws Exception {
		...
		try {
			...
			captureScreenshot("testSort_MyAccount_ReviewResponsesCol");
