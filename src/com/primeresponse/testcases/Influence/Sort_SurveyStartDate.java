...
public class Sort_SurveyStartDate extends DriverTestCase {

	@Test
	public void testSort_SurveyStartDate() throws Exception {
		...
		try {
			...
			influenceHelper.sort_SurveyStartDate();
			ExecutionLog.Log("Method to verify sorting functionality of Survey Start Date column");

		}

		catch (Error e) {
			captureScreenshot("testSort_SurveyStartDate");
