...
public class Verify_SurveysReport extends DriverTestCase {
	...
	public void testVerify_SurveysReport() throws Exception {
		...
		try {
			...
			influenceHelper.verify_SurveysReport();
			ExecutionLog.Log("Verify reports of surveys on Influence > Surveys page.");
