...
public class Sort_SurveyName extends DriverTestCase {

	@Test
	public void testSort_SurveyName() throws Exception {
		...
		try {
			...
			influenceHelper.sort_SurveyName();
			ExecutionLog.Log("Verify sorting functionality of Name column");

		}

		catch (Error e) {
			captureScreenshot("testSort_SurveyName");
