...
public class Sort_MetricsLastSupportCol extends DriverTestCase  {

	@Test
	public void testSort_MetricsLastSupportCol() throws Exception {
		...
		try {
			...
			supportHelper.sort_MetricsLastSupportCol();
			ExecutionLog.Log("Verify sorting functionality of 'Last Support' column");
		
		}
		catch (Error e) {
			captureScreenshot("testSort_MetricsLastSupportCol");
