...
public class Sort_MetricsExternalReviewsCol extends DriverTestCase  {

	@Test
	public void testSort_MetricsExternalReviewsCol() throws Exception {
		...
		try {
			...
			supportHelper.sort_MetricsExternalReviewsCol();
			ExecutionLog.Log("Verify sorting functionality of 'External Reviews' column ");
		
		}
		catch (Error e) {
			captureScreenshot("testSort_MetricsExternalReviewsCol");
