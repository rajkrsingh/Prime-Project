...
public class Sort_MetricsEmailSentCol extends DriverTestCase  {

	@Test
	public void testSort_MetricsEmailSentCol() throws Exception {
		...
		try {
			...
			supportHelper.sort_MetricsEmailSentCol();
			ExecutionLog.Log("Verify process of sorting Email sent column");
		
		}
		catch (Error e) {
			captureScreenshot("testSort_MetricsEmailSentCol");
