...
public class Sort_AccountStatuses_VerticalCol extends DriverTestCase  {

	@Test
	public void testSort_AccountStatuses_VerticalCol() throws Exception {
		...
		try {
			...
			supportHelper.sort_AccountStatuses_VerticalCol();
			ExecutionLog.Log("Verify sorting functionality of vertical column on Support > Account Statuses page");
		
		}
		catch (Error e) {
			captureScreenshot("testSort_AccountStatuses_VerticalCol");
