...
public class Delete_Goals extends DriverTestCase  {

	@Test
	public void testDelete_Goals() throws Exception {
		...
		try {
			...
			supportHelper.delete_Goals();
			ExecutionLog.Log("Verify process of creating new goals.");

			// Check success message
			headerHelper.checkSuccessMessage("Record was successfully deleted.");	
			ExecutionLog.Log("success message");
			

		}
		catch (Error e) {
			captureScreenshot("Delete_Goals");
			ExecutionLog.LogErrorMessage(e);
			throw e;
		} catch (Exception e) {
			captureScreenshot("testDelete_Goals");
