...
public class Sort_MetricsAccountCol extends DriverTestCase  {

	@Test
	public void testSort_MetricsAccountCol() throws Exception {
		...
		try {
			...
			supportHelper.sort_MetricsAccountCol();
			ExecutionLog.Log("Verify sorting functionality of 'Account' column ");
		
		}
		catch (Error e) {
			captureScreenshot("testSort_MetricsAccountCol");
