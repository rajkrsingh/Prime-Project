...
public class Delete_Communication extends DriverTestCase {

	@Test
	public void testDelete_Communication() throws Exception {
		...
		try {
			...
			// Delete white label
			supportHelper.deleteCommunication("Test360");
			ExecutionLog.Log("Delete white lable");

			//verify the success notification
			headerHelper.checkSuccessMessage("Communications support has been successfully removed.");	
			ExecutionLog.Log("success message");

		}

		catch (Error e) {
			captureScreenshot("testDelete_Communication");
