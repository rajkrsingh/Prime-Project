...
public class Search_ExternalFeed extends DriverTestCase{

	@Test
	public void testSearch_ExternalFeed() throws Exception {
		...
		try {
			...
			trackHelper.Search_ExternalFeed();
			ExecutionLog.Log("Verify random search of any external feed");

		}

		catch (Error e) {
			captureScreenshot("testSearch_ExternalFeed");
