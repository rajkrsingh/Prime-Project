...
public class Sort_TrackCompetitiorsAccountCol extends DriverTestCase {
	
	@Test
	public void testSort_TrackCompetitiorsAccountCol() throws Exception {
		...
		try {
			...
			trackHelper.sort_TrackCompetitiorsAccountCol();
			ExecutionLog.Log("Verify sorting functionality of Account column under Track >Competitors latest reviews widget.");
		}

		catch (Error e) {
			captureScreenshot("testSort_TrackCompetitiorsAccountCol");
