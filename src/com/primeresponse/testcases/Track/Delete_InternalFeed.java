...
public class Delete_InternalFeed extends DriverTestCase {
	
	@Test
	public void testDelete_InternalFeed() throws Exception {
		...
		try {
			...
			trackHelper.deleteInternalFeed();
			...
			captureScreenshot("testDelete_InternalFeed");
