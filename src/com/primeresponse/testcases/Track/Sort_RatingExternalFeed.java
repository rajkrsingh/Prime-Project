...
public class Sort_RatingExternalFeed extends DriverTestCase{

	@Test
	public void testSort_RatingExternalFeed() throws Exception {
		...
		try {
			...
			trackHelper.checkRatingSorting();
			ExecutionLog.Log("check sorting of rating columns");			

		}

		catch (Error e) {
			captureScreenshot("testSort_RatingExternalFeed");
