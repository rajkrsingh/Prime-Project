...
public class Sort_TrackCompetitiorsDescriptionCol extends DriverTestCase {
	
	@Test
	public void testSort_TrackCompetitiorsDescriptionCol() throws Exception {
		...
		try {
			...
			trackHelper.sort_TrackCompetitiorsDescriptionCol();
			ExecutionLog.Log("Verify sorting functionality of Description column under Track >Competitors latest reviews widget.");
		}

		catch (Error e) {
			captureScreenshot("testSort_TrackCompetitiorsDescriptionCol");
