...
public class Delete_KPI_Template extends DriverTestCase {
	
	@Test
	public void testDelete_KPI_Template() throws Exception {
		...
		try {
			...
			adminHelper.delete_KPI_Template();
			ExecutionLog.Log("Verify process of deleting KPI template");
			...
			captureScreenshot("testDelete_KPI_Template");
