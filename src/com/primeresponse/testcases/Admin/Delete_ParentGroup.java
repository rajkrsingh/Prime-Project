...
public class Delete_ParentGroup extends DriverTestCase{
	
	@Test
	public void testDelete_ParentGroup() throws Exception {
		...
		try {
			...
			// Delete Parent Group 
			adminHelper.deleteGroup("Test360 Parent Group");
			ExecutionLog.Log("Click on Admin > Groups");
			...
			captureScreenshot("testDelete_ParentGroup");
