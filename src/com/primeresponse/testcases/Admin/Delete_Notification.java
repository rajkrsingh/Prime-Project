...
public class Delete_Notification extends DriverTestCase {
	
	@Test
	public void testDelete_Notification() throws Exception {
		...
		try {
			...
			adminHelper.delete_Notification();
			ExecutionLog.Log("Verify process of deleting any randomly notification");
			
			//verify the success notification
			headerHelper.checkSuccessMessage("Notification was successfully removed.");	
			ExecutionLog.Log("success message");	
			
		}
        
		catch (Error e) {
			captureScreenshot("testDelete_Notification");
