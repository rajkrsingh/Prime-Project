...
public class Sort_SiteDetailSiteScore extends DriverTestCase{

	@Test
	public void testSort_SiteDetailSiteScore() throws Exception {
		...
		try {
			...
			profileHelper.sort_SiteDetailSiteScore();
			ExecutionLog.Log("Verify sorting functionality of site score column on Site Detail page");
			...
			captureScreenshot("testSort_SiteDetailSiteScore");
