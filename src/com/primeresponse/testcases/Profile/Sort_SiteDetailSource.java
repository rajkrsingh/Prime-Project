...
public class Sort_SiteDetailSource extends DriverTestCase{

	@Test
	public void testSort_SiteDetailSource() throws Exception {
		...
		try {
			...
			profileHelper.sort_SiteDetailSource();
			ExecutionLog.Log("Verify sorting functionality of source column on Site Detail page");
			...
			captureScreenshot("testSort_SiteDetailSource");
