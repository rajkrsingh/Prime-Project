...
public class Sort_SiteDetailDescription extends DriverTestCase{

	@Test
	public void testSort_SiteDetailDescription() throws Exception {
		...
		try {
			...
			profileHelper.sort_SiteDetailDescription();
			ExecutionLog.Log("Verify sorting functionality of description column on Site Detail page");
			...
			captureScreenshot("testSort_SiteDetailDescription");
