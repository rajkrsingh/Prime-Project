...
//	}
	...
	// Handle clickAt action
	public void clickAt(String locator, int x, int y)
	{
		this.WaitForElementPresent(locator, 50);
		WebElement tagElement = getWebDriver().findElement(ByLocator(locator));
		
		// build and perform click at with Advanced User Interactions API
		Actions builder = new Actions(getWebDriver());
		builder.moveToElement(tagElement).moveByOffset(x,y).click().build().perform();
	}
	...
	public void selectDropDown(String locator, String targetValue) {
		Assert.assertTrue(isElementPresent(locator), "Element Locator :"
				+ locator + " Not found");
		this.WaitForElementPresent(locator, 90);
	...
	// Execute java script
	public String javaScriptExecute(String javascrpt) {
...
public static void CheckDir() {
	...
	File dir = new File(workingDir +"\\Download");
...
public String GetFiles()
{
	...
	String workingDir = System.getProperty("user.dir");
	File folder = new File(workingDir +"\\Download");
